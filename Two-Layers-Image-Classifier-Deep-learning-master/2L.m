...
% lam_max1 = lambda1(max_index1); Din bästa lambda värde
% eta_max1 = eta1(max_index1);Din bästa eta värde
% 
...
%% run code with best param and minibatch
n_batch = 100;
eta =  0.0342 %eta_max1; 
n_epochs = 2;
rho = 0.9;
...
W1 = 0+0.001*randn(m,size(trainX,1));
W2 = 0+0.001*randn(size(trainY,1),m);
